...
def extrair(xlsx_path):
    ...
    PT_EN = {
        'AFEGANISTAO': 'Afghanistan', 'AFEGANISTÃO': 'Afghanistan', 'AFRICA DO SUL': 'South Africa', 'ALBANIA': 'Albania',
        'ALBÂNIA': 'Albania', 'ALEMANHA': 'Germany', 'ANGOLA': 'Angola', 'ARABIA SAUDITA': 'Saudi Arabia',
        'ARGELIA': 'Algeria', 'ARGENTINA': 'Argentina', 'ARGÉLIA': 'Algeria', 'ARMENIA': 'Armenia',
        'ARMÊNIA': 'Armenia', 'ARÁBIA SAUDITA': 'Saudi Arabia', 'AUSTRALIA': 'Australia', 'AUSTRIA': 'Austria',
        'AUSTRÁLIA': 'Australia', 'AZERBAIJAO': 'Azerbaijan', 'AZERBAIJÃO': 'Azerbaijan', 'BAHAMAS': 'Bahamas',
        'BAHREIN': 'Bahrain', 'BANGLADESH': 'Bangladesh', 'BARBADOS': 'Barbados', 'BAREIN': 'Bahrain',
        'BELARUS': 'Belarus', 'BELGICA': 'Belgium', 'BELIZE': 'Belize', 'BENIM': 'Benin',
        'BENIN': 'Benin', 'BIELORRUSSIA': 'Belarus', 'BIELORRÚSSIA': 'Belarus', 'BIRMANIA': 'Myanmar',
        'BIRMÂNIA': 'Myanmar', 'BOLIVIA': 'Bolivia', 'BOLÍVIA': 'Bolivia', 'BOSNIA': 'Bosnia and Herz.',
        'BOSNIA E HERZEGOVINA': 'Bosnia and Herz.', 'BOTSUANA': 'Botswana', 'BOTSWANA': 'Botswana', 'BRASIL': 'Brazil',
        'BRUNEI': 'Brunei', 'BULGARIA': 'Bulgaria', 'BULGÁRIA': 'Bulgaria', 'BURKINA FASO': 'Burkina Faso',
        'BURQUINA FASO': 'Burkina Faso', 'BURUNDI': 'Burundi', 'BUTAO': 'Bhutan', 'BUTÃO': 'Bhutan',
        'BÉLGICA': 'Belgium', 'BÓSNIA': 'Bosnia and Herz.', 'BÓSNIA E HERZEGOVINA': 'Bosnia and Herz.', 'CABO VERDE': 'Cabo Verde',
        'CAMAROES': 'Cameroon', 'CAMARÕES': 'Cameroon', 'CAMBOJA': 'Cambodia', 'CANADA': 'Canada',
        'CANADÁ': 'Canada', 'CATAR': 'Qatar', 'CAZAQUISTAO': 'Kazakhstan', 'CAZAQUISTÃO': 'Kazakhstan',
        'CHADE': 'Chad', 'CHILE': 'Chile', 'CHINA': 'China', 'CHIPRE': 'Cyprus',
        'CINGAPURA': 'Singapore', 'COLOMBIA': 'Colombia', 'COLÔMBIA': 'Colombia', 'COMORES': 'Comoros',
        'CONGO': 'Congo', 'COREIA DO NORTE': 'North Korea', 'COREIA DO SUL': 'South Korea', 'CORÉIA DO NORTE': 'North Korea',
        'CORÉIA DO SUL': 'South Korea', 'COSTA DO MARFIM': "Côte d'Ivoire", 'COSTA RICA': 'Costa Rica', 'CROACIA': 'Croatia',
        'CROÁCIA': 'Croatia', 'CUBA': 'Cuba', 'DINAMARCA': 'Denmark', 'DJIBOUTI': 'Djibouti',
        'DJIBUTI': 'Djibouti', 'EGITO': 'Egypt', 'EL SALVADOR': 'El Salvador', 'EMIRADOS ARABES': 'United Arab Emirates',
        'EMIRADOS ARABES UNIDOS': 'United Arab Emirates', 'EMIRADOS ÁRABES': 'United Arab Emirates', 'EMIRADOS ÁRABES UNIDOS': 'United Arab Emirates', 'EQUADOR': 'Ecuador',
        'ERITREIA': 'Eritrea', 'ESLOVAQUIA': 'Slovakia', 'ESLOVENIA': 'Slovenia', 'ESLOVÁQUIA': 'Slovakia',
        'ESLOVÊNIA': 'Slovenia', 'ESPANHA': 'Spain', 'ESTADOS UNIDOS': 'United States of America', 'ESTONIA': 'Estonia',
        'ESTÔNIA': 'Estonia', 'ETIOPIA': 'Ethiopia', 'ETIÓPIA': 'Ethiopia', 'EUA': 'United States of America',
        'FIJI': 'Fiji', 'FILIPINAS': 'Philippines', 'FINLANDIA': 'Finland', 'FINLÂNDIA': 'Finland',
        'FRANCA': 'France', 'FRANÇA': 'France', 'GABAO': 'Gabon', 'GABÃO': 'Gabon',
        'GAMBIA': 'Gambia', 'GANA': 'Ghana', 'GEORGIA': 'Georgia', 'GEÓRGIA': 'Georgia',
        'GRECIA': 'Greece', 'GROENLANDIA': 'Greenland', 'GROENLÂNDIA': 'Greenland', 'GRÉCIA': 'Greece',
        'GUATEMALA': 'Guatemala', 'GUIANA': 'Guyana', 'GUINE': 'Guinea', 'GUINE BISSAU': 'Guinea-Bissau',
        'GUINE EQUATORIAL': 'Eq. Guinea', 'GUINE-BISSAU': 'Guinea-Bissau', 'GUINÉ': 'Guinea', 'GUINÉ BISSAU': 'Guinea-Bissau',
        'GUINÉ EQUATORIAL': 'Eq. Guinea', 'GUINÉ-BISSAU': 'Guinea-Bissau', 'GÂMBIA': 'Gambia', 'HAITI': 'Haiti',
        'HOLANDA': 'Netherlands', 'HONDURAS': 'Honduras', 'HUNGRIA': 'Hungary', 'IEMEN': 'Yemen',
        'INDIA': 'India', 'INDONESIA': 'Indonesia', 'INDONÉSIA': 'Indonesia', 'INGLATERRA': 'United Kingdom',
        'IRA': 'Iran', 'IRAO': 'Iran', 'IRAQUE': 'Iraq', 'IRLANDA': 'Ireland',
        'IRÃ': 'Iran', 'IRÃO': 'Iran', 'ISLANDIA': 'Iceland', 'ISLÂNDIA': 'Iceland',
        'ISRAEL': 'Israel', 'ITALIA': 'Italy', 'ITÁLIA': 'Italy', 'IÊMEN': 'Yemen',
        'JAMAICA': 'Jamaica', 'JAPAO': 'Japan', 'JAPÃO': 'Japan', 'JORDANIA': 'Jordan',
        'JORDÂNIA': 'Jordan', 'KOSOVO': 'Kosovo', 'KUWAIT': 'Kuwait', 'LAOS': 'Laos',
        'LESOTO': 'Lesotho', 'LETONIA': 'Latvia', 'LETÔNIA': 'Latvia', 'LIBANO': 'Lebanon',
        'LIBERIA': 'Liberia', 'LIBIA': 'Libya', 'LIBÉRIA': 'Liberia', 'LITUANIA': 'Lithuania',
        'LITUÂNIA': 'Lithuania', 'LUXEMBURGO': 'Luxembourg', 'LÍBANO': 'Lebanon', 'LÍBIA': 'Libya',
        'MACEDONIA': 'Macedonia', 'MACEDONIA DO NORTE': 'Macedonia', 'MACEDÔNIA': 'Macedonia', 'MACEDÔNIA DO NORTE': 'Macedonia',
        'MADAGASCAR': 'Madagascar', 'MADAGÁSCAR': 'Madagascar', 'MALASIA': 'Malaysia', 'MALAUI': 'Malawi',
        'MALAUÍ': 'Malawi', 'MALAWI': 'Malawi', 'MALDIVAS': 'Maldives', 'MALI': 'Mali',
        'MALTA': 'Malta', 'MALÁSIA': 'Malaysia', 'MARROCOS': 'Morocco', 'MAURICIA': 'Mauritius',
        'MAURICIO': 'Mauritius', 'MAURITANIA': 'Mauritania', 'MAURITÂNIA': 'Mauritania', 'MAURÍCIA': 'Mauritius',
        'MAURÍCIO': 'Mauritius', 'MEXICO': 'Mexico', 'MIANMAR': 'Myanmar', 'MOCAMBIQUE': 'Mozambique',
        'MOLDAVIA': 'Moldova', 'MOLDOVA': 'Moldova', 'MOLDÁVIA': 'Moldova', 'MONGOLIA': 'Mongolia',
        'MONGÓLIA': 'Mongolia', 'MONTENEGRO': 'Montenegro', 'MOÇAMBIQUE': 'Mozambique', 'MYANMAR': 'Myanmar',
        'MÉXICO': 'Mexico', 'NAMIBIA': 'Namibia', 'NAMÍBIA': 'Namibia', 'NEPAL': 'Nepal',
        'NICARAGUA': 'Nicaragua', 'NICARÁGUA': 'Nicaragua', 'NIGER': 'Niger', 'NIGERIA': 'Nigeria',
        'NIGÉRIA': 'Nigeria', 'NORUEGA': 'Norway', 'NOVA ZELANDIA': 'New Zealand', 'NOVA ZELÂNDIA': 'New Zealand',
        'NÍGER': 'Niger', 'OMA': 'Oman', 'OMÃ': 'Oman', 'PAISES BAIXOS': 'Netherlands',
        'PALESTINA': 'Palestine', 'PANAMA': 'Panama', 'PANAMÁ': 'Panama', 'PAPUA NOVA GUINE': 'Papua New Guinea',
        'PAPUA NOVA GUINÉ': 'Papua New Guinea', 'PAPUA-NOVA GUINE': 'Papua New Guinea', 'PAPUA-NOVA GUINÉ': 'Papua New Guinea', 'PAQUISTAO': 'Pakistan',
        'PAQUISTÃO': 'Pakistan', 'PARAGUAI': 'Paraguay', 'PAÍSES BAIXOS': 'Netherlands', 'PERU': 'Peru',
        'POLONIA': 'Poland', 'POLÔNIA': 'Poland', 'PORTO RICO': 'Puerto Rico', 'PORTUGAL': 'Portugal',
        'QATAR': 'Qatar', 'QUENIA': 'Kenya', 'QUIRGUISTAO': 'Kyrgyzstan', 'QUIRGUISTÃO': 'Kyrgyzstan',
        'QUÊNIA': 'Kenya', 'RD CONGO': 'Dem. Rep. Congo', 'RDC': 'Dem. Rep. Congo', 'REINO UNIDO': 'United Kingdom',
        'REPUBLICA CENTRO-AFRICANA': 'Central African Rep.', 'REPUBLICA DEMOCRATICA DO CONGO': 'Dem. Rep. Congo', 'REPUBLICA DO CONGO': 'Congo', 'REPUBLICA DOMINICANA': 'Dominican Rep.',
        'REPUBLICA TCHECA': 'Czechia', 'REPÚBLICA CENTRO-AFRICANA': 'Central African Rep.', 'REPÚBLICA DEMOCRÁTICA DO CONGO': 'Dem. Rep. Congo', 'REPÚBLICA DO CONGO': 'Congo',
        'REPÚBLICA DOMINICANA': 'Dominican Rep.', 'REPÚBLICA TCHECA': 'Czechia', 'ROMENIA': 'Romania', 'ROMÊNIA': 'Romania',
        'RUANDA': 'Rwanda', 'RUSSIA': 'Russia', 'RÚSSIA': 'Russia', 'SAO TOME': 'São Tomé and Principe',
        'SAO TOME E PRINCIPE': 'São Tomé and Principe', 'SEICHELES': 'Seychelles', 'SENEGAL': 'Senegal', 'SERRA LEOA': 'Sierra Leone',
        'SERVIA': 'Serbia', 'SEYCHELLES': 'Seychelles', 'SINGAPURA': 'Singapore', 'SIRIA': 'Syria',
        'SOMALIA': 'Somalia', 'SOMÁLIA': 'Somalia', 'SRI LANKA': 'Sri Lanka', 'SUDAO': 'Sudan',
        'SUDAO DO SUL': 'S. Sudan', 'SUDÃO': 'Sudan', 'SUDÃO DO SUL': 'S. Sudan', 'SUECIA': 'Sweden',
        'SUICA': 'Switzerland', 'SURINAME': 'Suriname', 'SUÉCIA': 'Sweden', 'SUÍÇA': 'Switzerland',
        'SÃO TOMÉ': 'São Tomé and Principe', 'SÃO TOMÉ E PRÍNCIPE': 'São Tomé and Principe', 'SÉRVIA': 'Serbia', 'SÍRIA': 'Syria',
        'TADJIQUISTAO': 'Tajikistan', 'TADJIQUISTÃO': 'Tajikistan', 'TAILANDIA': 'Thailand', 'TAILÂNDIA': 'Thailand',
        'TAIWAN': 'Taiwan', 'TANZANIA': 'Tanzania', 'TANZÂNIA': 'Tanzania', 'TCHEQUIA': 'Czechia',
        'TCHÉQUIA': 'Czechia', 'TIMOR LESTE': 'Timor-Leste', 'TIMOR-LESTE': 'Timor-Leste', 'TOGO': 'Togo',
        'TRINIDAD E TOBAGO': 'Trinidad and Tobago', 'TUNISIA': 'Tunisia', 'TUNÍSIA': 'Tunisia', 'TURCOMENISTAO': 'Turkmenistan',
        'TURCOMENISTÃO': 'Turkmenistan', 'TURQUIA': 'Turkey', 'UCRANIA': 'Ukraine', 'UCRÂNIA': 'Ukraine',
        'UGANDA': 'Uganda', 'URUGUAI': 'Uruguay', 'USA': 'United States of America', 'UZBEQUISTAO': 'Uzbekistan',
        'UZBEQUISTÃO': 'Uzbekistan', 'VANUATU': 'Vanuatu', 'VENEZUELA': 'Venezuela', 'VIETNA': 'Vietnam',
        'VIETNAME': 'Vietnam', 'VIETNÃ': 'Vietnam', 'ZAMBIA': 'Zambia', 'ZIMBABUE': 'Zimbabwe',
        'ZIMBÁBUE': 'Zimbabwe', 'ZÂMBIA': 'Zambia', 'ÁFRICA DO SUL': 'South Africa', 'ÁUSTRIA': 'Austria',
        'ÍNDIA': 'India',
    }
    def norm_pais(pais):
    ...
    for nome, sheet_name in tema_sheets.items():
        ...
        # ---- Bolsas do tema ----
        bolsas_prev_total = v(wst2, 'D4')
        bolsas_exec_total = v(wst2, 'E4')
        missoes_prev_total = v(wst2, 'B4')
        missoes_exec_total = v(wst2, 'C4')

        # Executado de bolsas por ano: linha 'Bolsas do Tema' logo acima do TOTAL da tabela de execução
        bolsas_exec_row = (exec_total_row - 1) if exec_total_row else None
        bolsas_por_ano = []
        for a, c in zip(anos5, cols):
            bp = v(wst2, f'{c}{bolsas_row}')
            be = v(wst2, f'{c}{bolsas_exec_row}') if bolsas_exec_row else 0
            bolsas_por_ano.append({'ano': a, 'previsto': bp, 'executado': be, 'saldo': bp - be, 'pct': (be/bp if bp else 0)})

        tema_bolsas = {'previsto': bolsas_prev_total, 'executado': bolsas_exec_total,
                       'saldo': bolsas_prev_total - bolsas_exec_total,
                       'pct': (bolsas_exec_total / bolsas_prev_total if bolsas_prev_total else 0),
                       'por_ano': bolsas_por_ano}
        tema_missoes_totais = {'previsto': missoes_prev_total, 'executado': missoes_exec_total}
        ...
        temas[nome] = {'kpis': {'previsto': total_prev, 'executado': total_exec, 'saldo': total_saldo, 'pct': total_pct, 'status': pct_status(total_pct)},
                        ...
                        'bolsas': tema_bolsas, 'missoes_totais': tema_missoes_totais}
    result['temas'] = temas
...
def extrair_parcerias(xlsx_path):
    wb = openpyxl.load_workbook(xlsx_path, data_only=True)
    if 'Parcerias por Tema' not in wb.sheetnames:
        return None
    ws = wb['Parcerias por Tema']

    def norm_pais_parceria(pais):
        if not pais: return None
        p = str(pais).strip().upper()
        # reaproveita o mesmo dicionário PT_EN usado no restante do painel
        import re as _re
        PT_EN_LOCAL = {
            'AFRICA DO SUL':'South Africa', 'ÁFRICA DO SUL':'South Africa', 'ALEMANHA':'Germany',
            'ANGOLA':'Angola', 'ARGENTINA':'Argentina', 'BOLIVIA':'Bolivia', 'BOLÍVIA':'Bolivia',
            'BELGICA':'Belgium', 'BÉLGICA':'Belgium', 'CANADA':'Canada', 'CANADÁ':'Canada',
            'CHILE':'Chile', 'COLOMBIA':'Colombia', 'COLÔMBIA':'Colombia', 'CUBA':'Cuba',
            'EUA':'United States of America', 'ESTADOS UNIDOS':'United States of America',
            'EL SALVADOR':'El Salvador', 'ESPANHA':'Spain', 'FRANCA':'France', 'FRANÇA':'France',
            'ITALIA':'Italy', 'ITÁLIA':'Italy', 'MOCAMBIQUE':'Mozambique', 'MOÇAMBIQUE':'Mozambique',
            'MEXICO':'Mexico', 'MÉXICO':'Mexico', 'PERU':'Peru', 'POLONIA':'Poland', 'POLÔNIA':'Poland',
            'PORTUGAL':'Portugal', 'REINO UNIDO':'United Kingdom', 'SUECIA':'Sweden', 'SUÉCIA':'Sweden',
            'TUNISIA':'Tunisia', 'TUNÍSIA':'Tunisia', 'URUGUAI':'Uruguay',
        }
        return PT_EN_LOCAL.get(p, p.title())

    registros = []
    tema_atual = titulo_atual = None
    for r in range(2, ws.max_row + 1):
        t = ws.cell(r, 1).value
        ti = ws.cell(r, 2).value
        if t: tema_atual = t
        if ti: titulo_atual = ti
        inst = ws.cell(r, 4).value
        regiao = ws.cell(r, 3).value
        pais = ws.cell(r, 5).value
        if not inst: continue
        registros.append({'tema': tema_atual, 'titulo_tema': titulo_atual, 'regiao': regiao,
                           'instituicao': inst, 'pais': pais, 'pais_en': norm_pais_parceria(pais)})

    resumo_por_tema = []
    resumo_total = None
    if 'Resumo por Tema' in wb.sheetnames:
        wsr = wb['Resumo por Tema']
        for r in range(2, wsr.max_row + 1):
            tema = wsr.cell(r, 1).value
            if not tema: continue
            if str(tema).strip().upper() == 'TOTAL':
                resumo_total = {'sul': wsr.cell(r, 3).value or 0, 'norte': wsr.cell(r, 4).value or 0, 'total': wsr.cell(r, 5).value or 0}
                continue
            resumo_por_tema.append({'tema': tema, 'titulo': wsr.cell(r, 2).value,
                                     'sul': wsr.cell(r, 3).value or 0, 'norte': wsr.cell(r, 4).value or 0,
                                     'total': wsr.cell(r, 5).value or 0})
    if resumo_total is None:
        resumo_total = {'sul': sum(x['sul'] for x in resumo_por_tema), 'norte': sum(x['norte'] for x in resumo_por_tema), 'total': len(registros)}

    from collections import defaultdict as _dd
    agg = _dd(lambda: {'pais': '', 'pais_en': '', 'total_registros': 0, 'valor_total': 0, 'por_origem': {}})
    for reg in registros:
        key = reg['pais_en']
        if not key: continue
        a = agg[key]
        a['pais'] = reg['pais']; a['pais_en'] = key
        a['total_registros'] += 1
        a['por_origem'][reg['tema']] = a['por_origem'].get(reg['tema'], 0) + 1

    return {'registros': registros, 'resumo_por_tema': resumo_por_tema,
            'resumo_total': resumo_total, 'por_pais': list(agg.values())}


def main():
    if len(sys.argv) < 2:
        print("Uso: python3 atualizar_dashboard.py <planilha_controle.xlsx> [planilha_ppgs.xlsx] [planilha_parcerias.xlsx]")
        sys.exit(1)
    ...
    # Preserva os dados de PPGs e Parcerias já existentes no painel, a menos que uma planilha nova seja informada
    m = re.search(r"const DATA = (.*?);\n", html, flags=re.S)
    ppgs_atual = None
    parcerias_atual = None
    if m:
        try:
            atual = json.loads(m.group(1))
            ppgs_atual = atual.get('ppgs')
            parcerias_atual = atual.get('parcerias_prioritarias')
        except Exception:
            pass
    ...
    if len(sys.argv) >= 4:
        parcerias_novo = extrair_parcerias(sys.argv[3])
        if parcerias_novo:
            data['parcerias_prioritarias'] = parcerias_novo
            print("Dados de Parcerias Prioritárias atualizados a partir de", sys.argv[3])
    elif parcerias_atual:
        data['parcerias_prioritarias'] = parcerias_atual
